...
const CreateAutoNumberingSetupLocation= ({autoNumberingData, setAutoNumberingData}) => {
        ...
        <Grid item xs={10} md={10} lg={10} xl={11} className="mx-auto">
          ...
          <Grid container spacing={0}>
            ...
            <Grid item container direction="row" spacing={6} justify="flex-end" alignItems="center">
              <Grid item md={6} className="mx-auto">
                <label style={{ marginTop: '15px' }} className=" mb-2">
                  Do you want the Location Code to be Auto Generated
                </label>              
              </Grid>
              <Grid item md={6} className="mx-auto">
                <Switch
            ...
            <Grid item container direction="row" spacing={6} justify="flex-end" alignItems="center">
              <Grid item md={6}className="mx-auto">
                <label style={{ marginTop: '15px' }} className=" mb-2">
                Do you want the Location Code to be Alphanumeric
                </label>
              </Grid>
              <Grid item md={6} className="mx-auto">
              <Switch
            ...
            <Grid item container direction="row" spacing={6} justify="flex-end" alignItems="center">
              ...
              <Grid item md={6} className="mx-auto">
                <TextField
                  ...
                  placeholder="Alphanumeric Location"
                  variant="outlined"
                  fullWidth
                  size="small"
                  value={sequenceCode}
...
export default CreateAutoNumberingSetupLocation;
