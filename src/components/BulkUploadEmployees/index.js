...
const BulkUploadEmployees = props => {
  ...
  const [paginatedEmployee, setPaginatedEmployees] = useState([])
  const [employeeData, setEmployeeData] = useState([])
  const [showUploadedData, setShowUploadedData] = useState(false)
  const [recordsPerPage, setRecordsPerPage] = useState(10)
  const [page, setPage] = useState(1)
  const [isAutoGeneratedEmployeeId, setIsAutoGeneratedEmployeeId] = useState()
  ...
  useEffect(() => {
    getEmployeeCSVHeader()
  }, [])

  const [csvHeader, setCSVHeader] = useState()

  const getEmployeeCSVHeader = () => {
    apicaller('get', `${BASEURL}/employee/CSVHeader`)
      .then(res => {
        if (res.status === 200) {
          setIsAutoGeneratedEmployeeId(res.data.autoNumberingData.autoGenerated)
  ...
  const saveAll = e => {
    ...
    setBlocking(true)
    apicaller('post', `${BASEURL}/employee/uploadEmployee`, allFilesData)
      .then(res => {
        setBlocking(false)
        if (res.status === 200) {
        }
  ...
  const {
    ...
    onDrop: acceptedFiles => {
      acceptedFiles.forEach(async file => {
        ...
        setPaginatedEmployees(filteredArray)
  ...
  const validateUploadingData = () => {
    ...
    employeeData.forEach(item => {
      const data = {
        firstName: item.Legal_First_Name,
        lastName: item.Legal_Last_Name,
        middleName: item.Legal_Middle_Name,
        jobType: item.Job_Type,
        jobStatus: item.Job_Status,
        fatherOrHusband: item.FatherOrHusband,
        fatherOrHusbandName: item.FatherOrHusband_Name,
        dob: item.Date_Of_Birth,
        celebratesOn: item.Celebrates_On,
    ...
    setBlocking(true)
    apicaller('post', `${BASEURL}/employee/uploadEmployee`, fileData)
      .then(res => {
        if (res.status === 200) {
          setBlocking(false)
          ...
          if (res?.data?.errorData) {
            for (let i = 0; i < employeeData.length; i++) {
              employeeData[i]['errors'] = []
              if (res?.data?.errorData[i]?.errors) {
                employeeData[i].errors.push(res?.data?.errorData[i]?.errors)
              }
              data.push(employeeData[i])
                ...
                <>
                    ...
                    <div
                      ...
                      <Table className='table table-alternate-spaced mb-0'>
                        ...
                        <tbody>
                          {paginatedEmployee
                            .slice(
                              page * recordsPerPage > employeeData.length
                                ? page === 0
                                  ? 0
                              ...
                              <>
                                <tr>
                                  ...
                                  <td>
                                    <div className='d-flex align-items-center'>
                                      <div>
                                        <label
                                          className=''
                                          title={item.Legal_Middle_Name}>
                                          {item.Legal_Middle_Name}
                                        </label>
                                      </div>
                                    </div>
                                  </td>
                                  ...
                                  <td>
                                    <div className='d-flex align-items-center'>
                                      <div>
                                        <label className='' title={item.Job_Type}>
                                          {item.Job_Type}
                                        </label>
                                      </div>
                                    </div>
                                  ...
                                  <td>
                                    <div className='d-flex align-items-center'>
                                      <div>
                                        <label
                                          className=''
                                          title={item.FatherOrHusband_Name}>
                                          {item.FatherOrHusband_Name}
                                        </label>
                                      </div>
                                    </div>
                                  </td>
                                  ...
                                  <td>
                                    <div className='d-flex align-items-center'>
                                      <div>
                                        <label className='' title={item.Gender}>
                                          {item.Gender}
                                        </label>
                                      </div>
                                    </div>
                                  ...
                                  <td>
                                    <div className='d-flex align-items-center'>
                                      <div>
                                        <label
                                          className=''
                                          title={item.Employee_Department}>
                                  ...
                                  <td>
                                    <div className='d-flex align-items-center'>
                                      <div>
                                        <label
                                          className=''
                                          title={item.Employee_Designation}>
                  ...
                  <div className='d-flex align-items-center justify-content-center pt-3 mb-5'>
                    <Pagination
                      ...
                      count={Math.ceil(employeeData.length / recordsPerPage)}
                      variant='outlined'
                      shape='rounded'
                      selected={true}
                      page={page}
